...
<head>
    ...
    <script src="<?php echo base_url();?>assets/js/my_joined_activity.js"></script>
</head>
<body>
...
<div class="container">
    <section class="nav-side">
        <ul class="nav nav-pills nav-stacked" role="tablist">
            ...
            <li class="active" role="presentation"><a href="<?php echo base_url('activity/joined')?>">我参与的</a></li>
